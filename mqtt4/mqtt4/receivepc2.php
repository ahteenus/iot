...
//subscribe to topic cpu
    $subUp = $conn->subscribe('topic://cpupc2-asitha',array( SAM_WAIT => 1, SAM_MQTT_QOS => 0)) OR die('could not subscribe');
  ...
  if (!$msgUp->body=="")
  {
   ...
   // echo $msgUp->body;
      ...
      //  {
        ...
        curl_setopt($ch, CURLOPT_URL,"http://localhost/mythings/system/controller/reader_process.php");
